    ...
    <div className="min-h-screen bg-[#0A0A0B] flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 lg:px-24">
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="text-white/50 mb-8">Start building zero-hallucination knowledge graphs.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                {password.length > 0 && (
                   <span className={`text-xs ${password.length >= 8 ? 'text-green-400' : 'text-orange-400'}`}>
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl font-medium transition-colors flex justify-center items-center h-[52px]"
            >
